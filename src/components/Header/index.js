      ...
      <div className='container flex items-center justify-between'>
        ...
        <div className='flex items-center'>
          <div className='social flex items-center space-x-2 lg:space-x-5'>
            <div className='item instagram-item'>
              <Link
                href='https://www.instagram.com/herragro.co/'
                target='_blank'
            ...
            <div className='item linkedin-item'>
              <Link
          ...
          <div className='herragro-logo max-w-[50px] lg:max-w-[80px] ml-10'>
            <Link
